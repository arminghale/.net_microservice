...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'List', '/api/v1/ActionGroup', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Create', '/api/v1/ActionGroup', 'POST'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Edit', '/api/v1/ActionGroup', 'PUT'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Delete', '/api/v1/ActionGroup', 'DELETE'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'UnMock', '/api/v1/ActionGroup/unmock', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'List', '/api/v1/Action', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Create', '/api/v1/Action', 'POST'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Edit', '/api/v1/Action', 'PUT'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Delete', '/api/v1/Action', 'DELETE'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'UnMock', '/api/v1/Action/unmock', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'List', '/api/v1/Domain', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Create', '/api/v1/Domain', 'POST'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Edit', '/api/v1/Domain', 'PUT'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Delete', '/api/v1/Domain', 'DELETE'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'UnMock', '/api/v1/Domain/unmock', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'List', '/api/v1/DomainValue', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Create', '/api/v1/DomainValue', 'POST'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Edit', '/api/v1/DomainValue', 'PUT'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Delete', '/api/v1/DomainValue', 'DELETE'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'UnMock', '/api/v1/DomainValue/unmock', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'List', '/api/v1/Role', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Create', '/api/v1/Role', 'POST'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Edit', '/api/v1/Role', 'PUT'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Delete', '/api/v1/Role', 'DELETE'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'UnMock', '/api/v1/Role/unmock', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'List', '/api/v1/User', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Create', '/api/v1/User', 'POST'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Edit', '/api/v1/User', 'PUT'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Delete', '/api/v1/User', 'DELETE'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'UnMock', '/api/v1/User/unmock', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'List', '/api/v1/Tenant', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Create', '/api/v1/Tenant', 'POST'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Edit', '/api/v1/Tenant', 'PUT'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Delete', '/api/v1/Tenant', 'DELETE'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'UnMock', '/api/v1/Tenant/unmock', 'GET'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Update', '/api/v1/RACC/update', 'POST'
...
INSERT INTO "Action" ("ActionGroupId","Title","URL","Type") 
SELECT (SELECT "ActionGroup"."Id" FROM "ActionGroup" WHERE "Title" = 'Service'), 'Update', '/api/v1/UACC/update', 'POST'
